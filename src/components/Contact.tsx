      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-neutral-400 font-light max-w-2xl mx-auto">
            I'm open to internships, frontend development roles, and freelance projects.
            If you have something to build or a team to grow — let's talk.
          </p>
        </motion.div>
        ...
        <motion.div 
          ...
          className="flex flex-wrap justify-center gap-4 mt-16 pt-12 border-t border-white/10"
        >
          ...
          <a
            ...
            className="flex items-center gap-2 px-6 py-3 rounded-full bg-white/5 border border-white/10 text-neutral-400 hover:text-white hover:bg-white/10 hover:scale-105 transition-all text-sm font-medium"
          >
            📄 Download Resume
          </a>
        </motion.div>
